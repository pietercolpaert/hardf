...
/*
  describe('The N3Writer module', function () {
    ...
    //should make N3Writer objects', function () {
      N3Writer().should.be.an.instanceof(N3Writer);
    });

    //should be an N3Writer constructor', function () {
  ...
  describe('An N3Writer instance', function () {
    ...
    //calls the done callback when ending the outputstream errors', function (done) {
    ...
    //sends output through end when no stream argument is given', function (done) {
